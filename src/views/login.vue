            ...
            <div class="login-form" v-bind:style="logFormStyle">
                ...
                <div class="form-container">
                    <div class="text-warper">
                        <img src="../assets/login/login_account.png" class="img-account" v-if="accountactive" alt="system" />
                        <img src="../assets/login/login_activeaccount.png" class="img-account" v-if="accountnormal" alt="system" />
                        <input type="text" v-model.trim="obj.user_name" autofocus placeholder="请输入账号" @focus="AccountFocus"
                            v-bind:class="account_animalte">
                        <div class="line"></div>
                    </div>
